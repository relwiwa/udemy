...
var gulp = require('gulp'),
  $ = require('gulp-load-plugins')(), // binds all modules starting with gulp- to dollarsign variable
...
function initBundlerWatch(file) {
  ...
  function bundle() {
    return bundler
      .bundle()
      .on('error', error => console.error.apply(error))
...
function createBundler(file) {
  // babel cannot load any modules, that is why browserify is necessary
